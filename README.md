...
![Главная страница Kasay Bank](docs/images/dashboard.png)
...
Frontend находится в [frontend/](./frontend) и представляет собой лаконичный веб-кабинет в стиле интернет-банка.
